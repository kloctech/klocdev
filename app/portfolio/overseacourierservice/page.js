    ...
    <main className="min-h-screen w-full bg-[#020617] text-slate-900">
      ...
      >
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-10">
          <div className="lg:col-span-2 space-y-6 text-slate-800 leading-relaxed">
            <p>
              ...
              Middle East operations, transforming their logistics management
              from manual Excel-based processes to a fully automated digital
              ecosystem. The app connects directly to Shopify stores,
              automatically pulling all orders into a centralized OCS dashboard
              where merchants can generate shipments individually or in bulk
        ...
        <div className="mt-10 rounded-2xl bg-slate-50 border border-slate-200 p-5 text-slate-800">
          ...
          sync and real-time tracking. Achieved zero spreadsheet dependency
          while managing the complete shipment lifecycle on one platform.
        </div>
      </div>
    </main>
  );
